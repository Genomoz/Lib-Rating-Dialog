package io.genemoz.ratingdialog;
...
public class RatingUtils {
    ...
    public void setDialog() {
        ...
        MaterialCardView btnLater = dialog.findViewById(R.id.FBCancel);
        ...
        LinearLayout defaultLayout = dialog.findViewById(R.id.defaultLayout);
